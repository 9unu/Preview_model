...
# def predict(packet: InputOCR):  # local test 용
    """    
...
if __name__ == "__main__":    
    ...
    base_path = "ocr_tagging" if not os.environ.get("BASE_PATH") else os.environ.get("BASE_PATH")
    ...
    if not os.environ.get("POST_SERVER"):
        post_server = "http://localhost:5000/api/product/detail/one"
