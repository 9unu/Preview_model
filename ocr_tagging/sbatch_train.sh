...
stop_patience=5
train_fp="/local_datasets/p_ocr_dataset/parsing_data/train/"
valid_fp="/local_datasets/p_ocr_dataset/parsing_data/valid/"
base_path="./ckpt_ocr/model/"
label_info_file="meta.bin"
out_model_path="pytorch_model.bin"

# dataset path
fp="/local_datasets/p_ocr_dataset/"
save_p="/local_datasets/p_ocr_dataset/parsing_data/"
val_ratio=0.1
test_ratio=0.01
encoding="utf-8-sig"
...
tar -xf /data/ndn825/Preview_model/ocr_tagging/resources_ocr/p_ocr_dataset.tar -C /local_datasets/p_ocr_dataset/
echo "Data is ready!"
...
cp -rf /local_datasets/p_ocr_dataset/ ./resources_ocr/
