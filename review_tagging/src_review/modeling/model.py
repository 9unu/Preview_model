...
class ABSAModel(nn.Module):
    def __init__(self, config, num_sentiment, num_aspect, num_aspect2,  need_birnn=False, rnn_dim=128):
        ...
        self.num_sentiment,  self.num_aspect2 = num_sentiment, num_aspect2
    ...
    def forward(self, ids, mask=None, token_type_ids=None, target_aspect=None, target_aspect2=None, target_sentiment=None):
        ...
        if self.need_birnn:
            ...
            sentiment_output, aspect2_output = model_output,  model_output
        ...
        if target_aspect is not None and target_aspect2 is not None and target_sentiment is not None :
            ...
            aspect_loss = -1 * self.asp2_crf(aspect2_emmisions, target_aspect2, mask=mask.byte())
            loss = (sentiment_loss + aspect_loss) / 2

            return loss, sentiment, aspect2
        else:
            return sentiment, aspect2
