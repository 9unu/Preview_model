...
if __name__ == "__main__":
    ...
    parser.add_argument("--train_batch_size", type=int, default=1, help="한 batch에 속할 학습 데이터 샘플의 size")
    parser.add_argument("--valid_batch_size", type=int, default=1, help="한 batch에 속할 검증 데이터 샘플의 size")
    parser.add_argument("--init_model_path", type=str, default="monologg/koelectra-base-v3-discriminator", help="사용할 KoELECTRA의 종류")
    parser.add_argument("--max_length", type=int, default=512, help="토큰화된 문장의 최대 길이를 설정")
